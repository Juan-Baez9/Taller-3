...
public class Aerolinea {
    ...
    public void programarVuelo(String fecha, String codigoRuta, String nombreAvion) throws Exception {
        Ruta r = this.getRuta(codigoRuta);
        Avion a = null;
        ...
        if (r != null && a != null)
            this.vuelos.add(new Vuelo(r, fecha, a));
        else
            throw new Exception("El código o nombre suministrado es inválido.");
    ...
    public void registrarVueloRealizado(String fecha, String codigoRuta) throws Exception {
        ...
        for (Tiquete tiquete : v1.getTiquetes()) {
            if (tiquete == null) {
    ...
    public String consultarSaldoPendienteCliente(String identificadorCliente) {
        ...
        return String.valueOf(c1.calcularValorTotalTiquetes());
    }
